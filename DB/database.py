...
def fetch_real_estate_index():
    """
    Загружает индекс цен на жилье (Росстат/Дом.РФ)
    Можно заменить на API IRN.RU или загружать CSV вручную
    """
    # Данные по индексу цен на жилье (квартиры, вторичка, Москва)
    # Источник: https://rosstat.gov.ru/ или https://www.irn.ru/gd/

    # Пока используем тестовые данные (обновлять раз в квартал)
    REAL_ESTATE_DATA = {
        '2023-06-30': 250000,
        '2023-09-30': 258000,
        '2023-12-31': 265000,
...
def update_benchmarks_in_db():
    ...
    # Недвижимость
    real_estate = fetch_real_estate_index()
